...
workflow_configuration_structure = "config.json"  # URL to the configuration file skeleton ./.funbots/workflow/conf_generator/
...
with open(workflow_configuration_file, "w") as outFile:
    outFile.write(
        "-- This file was automatically generated by the fun-bots Github on %s!\n" % datetime.today().strftime(
            '%d-%m-%Y %H:%M:%S'))
