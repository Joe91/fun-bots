...
|---	|---	|---	|---	|
|   ![MP_001](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_001.jpg?raw=true) 	|   `MP_001`	| **Grand Bazaar** | `TDM`, `TDM CQ`, `Rush`, `CQ Small`, `CQ Large` |
|   ![MP_003](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_003.jpg?raw=true) 	|   `MP_003`	| **Teheran Highway** | `TDM`, `TDM CQ`,`Rush`, `CQ Small` |
|   ![MP_007](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_007.jpg?raw=true) 	|   `MP_007`	| **Caspian Border** | `TDM`, `TDM CQ`, `Rush`, `CQ Small`, `CQ Large` |
|   ![MP_011](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_011.jpg?raw=true) 	|   `MP_011`	| **Seine Crossing** | `TDM`, `TDM CQ`, `Rush`, `CQ Small`, `CQ Large` |
|   ![MP_012](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_012.jpg?raw=true) 	|   `MP_012`	| **Operation Firestorm** | `TDM`, `TDM CQ`, `Rush`, `CQ Small`, `CQ Large` |
|   ![MP_013](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_013.jpg?raw=true) 	|   `MP_013`	| **Damavand Peak** | `TDM`, `TDM CQ`, `Rush`, `CQ Small` |
|   ![MP_017](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/mp_017.jpg?raw=true) 	|   `MP_017`	| **Noshahr Canals** | `TDM`, `TDM CQ`, `Rush`, `CQ Small` |
...
|   ![XP2_Office](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp2_office.jpg?raw=true) 	|   `XP2_Office`	| **Operation 925** |`TDM CQ`, `GM`, `CQ Dom` |
|   ![XP2_Skybar](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp2_skybar.jpg?raw=true) 	|   `XP2_Skybar`	| **Ziba Tower** |`TDM CQ`, `GM`, `CQ Dom` |
|   ![XP2_Palace](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp2_palace.jpg?raw=true) 	|   `XP2_Palace`	| **Donya Fortress** |`TDM CQ`, `GM`, `CQ Dom` |
|   ![XP3_Alborz](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp3_alborz.jpg?raw=true) 	|   `XP3_Alborz`	| **Alborz Mountains** | `TDM`, `TDM CQ` |
|   ![XP3_Desert](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp3_desert.jpg?raw=true) 	|   `XP3_Desert`	| **Bandar Desert** | `TDM`, `TDM CQ`, `CQ Small` |
|   ![XP3_Shield](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp3_shield.jpg?raw=true) 	|   `XP3_Shield`	| **Armored Shield** | `TDM`, `TDM CQ`, `CQ Small` |
|   ![XP3_Valley](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp3_valley.jpg?raw=true) 	|   `XP3_Valley`	| **Death Valley** | `TDM`, `TDM CQ`, `CQ Small` |
|   ![XP4_FD](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp4_fd.jpg?raw=true) 	|   `XP4_FD`	| **Markaz Monolith** | `TDM`, `TDM CQ`, `GM` |
|   ![XP4_Rubble](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp4_rubble.jpg?raw=true) 	|   `XP4_Rubble`	| **Talah Market** | `TDM`, `TDM CQ`, `GM` |
|   ![XP4_Quake](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp4_quake.jpg?raw=true) 	|   `XP4_Quake`	| **Epicenter** | `TDM`, `TDM CQ`, `GM` |
|   ![XP4_Parl](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp4_parl.jpg?raw=true) 	|   `XP4_Parl`	| **Azadi Palace** | `TDM`, `TDM CQ`, `GM` |
|   ![XP5_001](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp5_001.jpg?raw=true) 	|   `XP5_001`	| **Operation Riverside** | `TDM`, `TDM CQ`, `CQ Small` |
|   ![XP5_002](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp5_002.jpg?raw=true) 	|   `XP5_002`	| **Nebandan Flats** | `TDM`, `TDM CQ`, `CQ Small` |
|   ![XP5_003](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp5_003.jpg?raw=true) 	|   `XP5_003`	| **Kiasar Railroad** | `TDM`, `TDM CQ`, `CTF`, `CQ Small` |
|   ![XP5_004](https://github.com/Joe91/fun-bots/blob/master/Screenshots/Maps/xp5_004.jpg?raw=true) 	|   `XP5_004`	| **Sabalan Pipeline** | `TDM`, `TDM CQ`, `CQ Small` |
