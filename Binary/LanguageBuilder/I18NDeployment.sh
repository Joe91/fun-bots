...
echo "https://$($GITHUB_LANG_TOKEN)@github.com" > "$USERPROFILE\.git-credentials"
...
git -C ${DIR} remote set-url origin https://$($GITHUB_LANG_TOKEN):x-oauth-basic@github.com/Joe91/fun-bots.git
