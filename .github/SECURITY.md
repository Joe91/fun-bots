...
- [Report a bug](https://github.com/Joe91/fun-bots/issues/new?assignees=&labels=bug&template=bug-report.yml)
...
You can report security bugs [here](https://github.com/Joe91/fun-bots/issues/new?assignees=&labels=bug&template=bug-report.yml), or you can report them confidentially by messaging Joe91 on the [Discord server](https://discord.gg/zNk3qCzk6x).
