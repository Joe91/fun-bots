...
function WeaponList:__init()
	self._weapons = {
		...
		Weapon('M4A1_RX01', '', {'Weapons/M4A1/U_M4A1_RX01', 'Weapons/M4A1/U_M4A1_HeavyBarrel', 'Weapons/M4A1/U_M4A1_Foregrip'}, WeaponTypes.Carabine, 'Weapons/M4A1/U_M4A1'),
		Weapon('M4A1_Kobra', '', {'Weapons/M4A1/U_M4A1_Kobra', 'Weapons/M4A1/U_M4A1_HeavyBarrel', 'Weapons/M4A1/U_M4A1_Foregrip'}, WeaponTypes.Carabine, 'Weapons/M4A1/U_M4A1'),
		...
		Weapon('M39EBR_EOTech', '', {'EOTech', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'Weapons/M39EBR/U_M39EBR_CAMO_1'}, WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		Weapon('M39EBR_Acog', '', {'Acog', 'Weapons/Common/NoPrimaryAccessory', 'Flashsuppressor', 'Weapons/M39EBR/U_M39EBR_CAMO_1'}, WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		Weapon('M39EBR_RifleScope', '', {'Rifle_Scope', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'Weapons/M39EBR/U_M39EBR_CAMO_2'}, WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		...
		Weapon('MK11_EOTech', '', {'EOTech', 'Weapons/Common/NoPrimaryAccessory', 'Flashsuppressor'}, WeaponTypes.Sniper, 'Weapons/MK11/U_MK11'),
		Weapon('MK11_Acog', '', {'Acog', 'TargetPointer', 'Weapons/Common/NoPrimaryAccessory'}, WeaponTypes.Sniper, 'Weapons/MK11/U_MK11'),
		Weapon('MK11_RifleScope', '', {'Rifle_Scope', 'Weapons/Common/NoPrimaryAccessory', 'Flashsuppressor'}, WeaponTypes.Sniper, 'Weapons/MK11/U_MK11'),
		Weapon('SKS_Kobra', '', {'Kobra', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'Weapons/SKS/U_SKS_CAMO_2'}, WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
		Weapon('SKS_PSO-1', '', {'PSO-1', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'Weapons/SKS/U_SKS_CAMO_2'}, WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
		Weapon('SKS_RifleScope', '', {'Rifle_Scope', 'Weapons/Common/NoPrimaryAccessory', 'Heavy_Barrel', 'Weapons/SKS/U_SKS_CAMO_1'}, WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
