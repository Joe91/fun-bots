...
function WeaponList:__init()
	self._weapons = {
		...
		Weapon('DAO-12_Frag', '', { 'Weapons/DAO-12/U_DAO-12_Frag', 'Kobra', 'ExtendedMag' }, WeaponTypes.Shotgun,
			'Weapons/DAO-12/U_DAO-12'),
		Weapon('DAO-12_Slug', '', { 'Weapons/DAO-12/U_DAO-12_Slug', 'Kobra', 'TargetPointer' }, WeaponTypes.Shotgun,
			'Weapons/DAO-12/U_DAO-12'),
		Weapon('Jackhammer_Flechette', 'XP1',
			{ 'Weapons/XP1_Jackhammer/U_Jackhammer_Flechette', 'Kobra', 'ExtendedMag', 'CAMO_1' }, WeaponTypes.Shotgun,
			'Weapons/XP1_Jackhammer/U_Jackhammer'),
		Weapon('Jackhammer_Frag', 'XP1', { 'Weapons/XP1_Jackhammer/U_Jackhammer_Frag', 'Kobra', 'ExtendedMag', 'CAMO_2' },
			WeaponTypes.Shotgun, 'Weapons/XP1_Jackhammer/U_Jackhammer'),
		Weapon('Jackhammer_Slug', 'XP1', { 'Weapons/XP1_Jackhammer/U_Jackhammer_Slug', 'Kobra', 'TargetPointer', 'CAMO_1' },
			WeaponTypes.Shotgun, 'Weapons/XP1_Jackhammer/U_Jackhammer'),
		Weapon('Saiga20_Flechette', '', { 'Weapons/SAIGA20K/U_Saiga_20k_Flechette', 'Kobra', 'ExtendedMag' },
			WeaponTypes.Shotgun, 'Weapons/SAIGA20K/U_SAIGA_20K'),
		Weapon('Saiga20_Frag', '', { 'Weapons/SAIGA20K/U_Saiga_20k_Frag', 'Kobra', 'ExtendedMag' }, WeaponTypes.Shotgun,
			'Weapons/SAIGA20K/U_SAIGA_20K'),
		Weapon('Saiga20_Slug', '', { 'Weapons/SAIGA20K/U_Saiga_20k_Slug', 'Kobra', 'ExtendedMag' }, WeaponTypes.Shotgun,
			'Weapons/SAIGA20K/U_SAIGA_20K'),
		Weapon('SPAS12_Flechette', 'XP2', { 'Weapons/XP2_SPAS12/U_SPAS12_Flechette', 'Kobra', 'ExtendedMag' },
		...
		Weapon('USAS-12_Slug', '', { 'Weapons/USAS-12/U_USAS-12_Slug', 'ExtendedMag', 'Kobra' }, WeaponTypes.Shotgun,
			'Weapons/USAS-12/U_USAS-12'),
		Weapon('M1014_Flechette', '', { 'Weapons/M1014/U_M1014_Flechette', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/M1014/U_M1014'),
		Weapon('M1014_Frag', '', { 'Weapons/M1014/U_M1014_Frag', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/M1014/U_M1014'),
		Weapon('M1014_Slug', '', { 'Weapons/M1014/U_M1014_Slug', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/M1014/U_M1014'),
		Weapon('870M_Flechette', '', { 'Weapons/Remington870/U_870_Flechette', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/Remington870/U_870'),
		Weapon('870M_Frag', '', { 'Weapons/Remington870/U_870_Frag', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/Remington870/U_870'),
		Weapon('870M_Slug', '', { 'Weapons/Remington870/U_870_Slug', 'ExtendedMag', 'RX01' }, WeaponTypes.Shotgun,
			'Weapons/Remington870/U_870'),
		...
		Weapon('SteyrAug_RX01', 'XP2', { 'RX01', 'Foregrip', 'Heavy_Barrel' }, WeaponTypes.Assault,
			'Weapons/XP2_SteyrAug/U_SteyrAug'),
		Weapon('SteyrAug_Kobra', 'XP2', { 'Kobra', 'Foregrip', 'Heavy_Barrel' }, WeaponTypes.Assault,
			'Weapons/XP2_SteyrAug/U_SteyrAug'),
		Weapon('F2000_RX01', '', { 'RX01', 'Foregrip', 'Heavy_Barrel', 'Camo_NWU' }, WeaponTypes.Assault,
			'Weapons/F2000/U_F2000'),
		Weapon('F2000_Kobra', '', { 'Kobra', 'Foregrip', 'Heavy_Barrel', 'Camo_PARTIZAN' }, WeaponTypes.Assault,
			'Weapons/F2000/U_F2000'),
		...
		Weapon('L85A2_RX01', 'XP1', { 'RX01', 'HeavyBarrel', 'ForeGrip', 'CAMO_1' }, WeaponTypes.Assault,
			'Weapons/XP1_L85A2/U_L85A2'),
		Weapon('L85A2_Kobra', 'XP1', { 'Kobra', 'HeavyBarrel', 'ForeGrip', 'CAMO_2' }, WeaponTypes.Assault,
			'Weapons/XP1_L85A2/U_L85A2'),
		Weapon('M16A4_RX01', '', { 'RX01', 'HeavyBarrel', 'Weapons/Common/NoSecondaryRail' }, WeaponTypes.Assault,
			'Weapons/M16A4/U_M16A4'),
		Weapon('M16A4_Kobra', '', { 'Kobra', 'HeavyBarrel', 'Weapons/Common/NoSecondaryRail' }, WeaponTypes.Assault,
			'Weapons/M16A4/U_M16A4'),
		Weapon('M16-Burst_RX01', '',
			{ 'Weapons/M16A4/U_M16A4_RX01', 'Weapons/M16A4/U_M16A4_HeavyBarrel', 'Weapons/M16A4/U_M16A4_Foregrip' },
			WeaponTypes.Assault, 'Weapons/M16A4/U_M16_Burst'),
		Weapon('M16-Burst_Kobra', '',
			{ 'Weapons/M16A4/U_M16A4_Kobra', 'Weapons/M16A4/U_M16A4_HeavyBarrel', 'Weapons/M16A4/U_M16A4_Foregrip' },
			WeaponTypes.Assault, 'Weapons/M16A4/U_M16_Burst'),
		...
		Weapon('SCAR-L_EOTech', 'XP2', { 'EOTech', 'Foregrip', 'HeavyBarrel' }, WeaponTypes.Assault,
			'Weapons/XP2_SCAR-L/U_SCAR-L'),
		Weapon('SCAR-L_Kobra', 'XP2', { 'Kobra', 'Foregrip', 'HeavyBarrel' }, WeaponTypes.Assault,
			'Weapons/XP2_SCAR-L/U_SCAR-L'),
		...
		Weapon('ASVal_RX01', '', { 'RX01', 'ExtendedMag', 'Weapons/Common/NoSecondaryAccessory' }, WeaponTypes.PDW,
			'Weapons/ASVal/U_ASVal'),
		...
		Weapon('PP-19_Kobra', 'XP1', { 'Kobra', 'FlashSuppressor', 'Targetpointer', 'CAMO_2' }, WeaponTypes.PDW,
			'Weapons/XP1_PP-19/U_PP-19'),
		Weapon('PP-19_RX01', 'XP1', { 'RX01', 'FlashSuppressor', 'Targetpointer', 'CAMO_1' }, WeaponTypes.PDW,
			'Weapons/XP1_PP-19/U_PP-19'),
		...
		Weapon('UMP45_RX01', '', { 'RX01', 'Flashsuppressor', 'Targetpointer', 'CAMO_1' }, WeaponTypes.PDW,
			'Weapons/UMP45/U_UMP45'),
		Weapon('UMP45_Kobra', '', { 'Kobra', 'Flashsuppressor', 'Targetpointer', 'CAMO_2' }, WeaponTypes.PDW,
			'Weapons/UMP45/U_UMP45'),
		...
		Weapon('MagpulPDR_Kobra', '', { 'Kobra', 'Flashsuppressor', 'Targetpointer' }, WeaponTypes.PDW,
			'Weapons/MagpulPDR/U_MagpulPDR'),
		Weapon('MagpulPDR_RX01', '', { 'RX01', 'Flashsuppressor', 'Targetpointer' }, WeaponTypes.PDW,
			'Weapons/MagpulPDR/U_MagpulPDR'),
		...
		Weapon('ACR_RX01', 'XP2', { 'RX01', 'HeavyBarrel', 'Foregrip', 'CAMO_1' }, WeaponTypes.Carabine,
			'Weapons/XP2_ACR/U_ACR'),
		Weapon('ACR_Kobra', 'XP2', { 'Kobra', 'HeavyBarrel', 'Foregrip', 'CAMO_2' }, WeaponTypes.Carabine,
			'Weapons/XP2_ACR/U_ACR'),
		...
		Weapon('HK53_RX01', 'XP1', { 'RX01', 'HeavyBarrel', 'Foregrip', 'CAMO_1' }, WeaponTypes.Carabine,
			'Weapons/XP1_HK53/U_HK53'),
		Weapon('HK53_Kobra', 'XP1', { 'Kobra', 'HeavyBarrel', 'Foregrip', 'CAMO_2' }, WeaponTypes.Carabine,
			'Weapons/XP1_HK53/U_HK53'),
		...
		Weapon('MTAR_Kobra', 'XP2', { 'Kobra', 'HeavyBarrel', 'Foregrip', 'CAMO_2' }, WeaponTypes.Carabine,
			'Weapons/XP2_MTAR/U_MTAR'),
		Weapon('QBZ-95B_Kobra', 'XP1', { 'Kobra', 'HeavyBarrel', 'TargetPointer' }, WeaponTypes.Carabine,
			'Weapons/XP1_QBZ-95B/U_QBZ-95B'),
		Weapon('QBZ-95B_RX01', 'XP1', { 'RX01', 'HeavyBarrel', 'TargetPointer' }, WeaponTypes.Carabine,
			'Weapons/XP1_QBZ-95B/U_QBZ-95B'),
		Weapon('SCAR-H_EOTech', '', { 'EOTech', 'HeavyBarrel', 'Foregrip', 'CAMO_DSRTTIGER' }, WeaponTypes.Carabine,
			'Weapons/SCAR-H/U_SCAR-H'),
		Weapon('SCAR-H_Kobra', '', { 'Kobra', 'HeavyBarrel', 'Foregrip', 'CAMO_BERKUT' }, WeaponTypes.Carabine,
			'Weapons/SCAR-H/U_SCAR-H'),
		...
		Weapon('LSAT_Kobra', 'XP2', { 'Kobra', 'ExtendedMag', 'Foregrip', 'CAMO_2' }, WeaponTypes.LMG,
			'Weapons/XP2_LSAT/U_LSAT'),
		...
		Weapon('Pecheneg_Kobra', '', { 'Kobra', 'Foregrip', 'ExtendedMag', 'Weapons/Pecheneg/U_Peceheneg_Camo_KAMYSH' },
			WeaponTypes.LMG, 'Weapons/Pecheneg/U_Pecheneg'),
		Weapon('Pecheneg_RX01', '', { 'RX01', 'Foregrip', 'ExtendedMag', 'Weapons/Pecheneg/U_Peceheneg_Camo_ATACS' },
			WeaponTypes.LMG, 'Weapons/Pecheneg/U_Pecheneg'),
		Weapon('QBB-95_Kobra', 'XP1', { 'Kobra', 'Foregrip', 'HeavyBarrel', 'CAMO_2' }, WeaponTypes.LMG,
			'Weapons/XP1_QBB-95/U_QBB-95'),
		Weapon('QBB-95_RX01', 'XP1', { 'RX01', 'Foregrip', 'HeavyBarrel', 'CAMO_1' }, WeaponTypes.LMG,
			'Weapons/XP1_QBB-95/U_QBB-95'),
		...
		Weapon('RPK_Kobra', '', { 'Weapons/RPK/U_RPK_Kobra', 'Weapons/RPK/U_RPK_HeavyBarrel', 'Weapons/RPK/U_RPK_Foregrip' },
			WeaponTypes.LMG, 'Weapons/RPK/U_RPK-74M'),
		Weapon('RPK_RXO1', '', { 'Weapons/RPK/U_RPK_RX01', 'Weapons/RPK/U_RPK_HeavyBarrel', 'Weapons/RPK/U_RPK_Foregrip' },
			WeaponTypes.LMG, 'Weapons/RPK/U_RPK-74M'),
		...
		Weapon('JNG90_PSO-1', 'XP2', { 'PSO-1', 'StraightPull', 'Target_Pointer', 'CAMO_2' }, WeaponTypes.Sniper,
			'Weapons/XP2_JNG90/U_JNG90'),
		Weapon('JNG90_RifleScope', 'XP2', { 'Rifle_Scope', 'StraightPull', 'Target_Pointer', 'CAMO_1' }, WeaponTypes.Sniper,
			'Weapons/XP2_JNG90/U_JNG90'),
		Weapon('L96_EOTech', 'XP1', { 'EOTech', 'StraightPull', 'TargetPointer', 'CAMO_ABU' }, WeaponTypes.Sniper,
			'Weapons/XP1_L96/U_L96'),
		Weapon('L96_Acog', 'XP1', { 'Acog', 'StraightPull', 'TargetPointer', 'CAMO_ABU' }, WeaponTypes.Sniper,
			'Weapons/XP1_L96/U_L96'),
		Weapon('L96_RifleScope', 'XP1', { 'Rifle_Scope', 'StraightPull', 'TargetPointer', 'CAMO_DIGIFLORA' },
			WeaponTypes.Sniper, 'Weapons/XP1_L96/U_L96'),
		...
		Weapon('M98B_RifleScope', '', { 'Rifle_Scope', 'StraightPull', 'Target_Pointer' }, WeaponTypes.Sniper,
			'Weapons/Model98B/U_M98B'),
		...
		Weapon('M40A5_RifleScope', '', { 'Rifle_Scope', 'StraightPull', 'Target_Pointer' }, WeaponTypes.Sniper,
			'Weapons/M40A5/U_M40A5'),
		...
		Weapon('SV98_RifleScope', '', { 'Rifle_Scope', 'StraightPull', 'Target_Pointer' }, WeaponTypes.Sniper,
			'Weapons/SV98/U_SV98'),
		Weapon('M39EBR_EOTech', '', { 'EOTech', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_1' },
			WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		Weapon('M39EBR_Acog', '', { 'Acog', 'Flashsuppressor', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_1' },
			WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		Weapon('M39EBR_RifleScope', '', { 'Rifle_Scope', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_2' },
			WeaponTypes.Sniper, 'Weapons/M39EBR/U_M39EBR'),
		Weapon('HK417_EOTech', 'XP2', { 'EOTech', 'TargetPointer', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/XP2_HK417/U_HK417'),
		Weapon('HK417_Acog', 'XP2', { 'Acog', 'TargetPointer', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/XP2_HK417/U_HK417'),
		Weapon('HK417_RifleScope', 'XP2', { 'Rifle_Scope', 'TargetPointer', 'Weapons/Common/NoPrimaryAccessory' },
			WeaponTypes.Sniper, 'Weapons/XP2_HK417/U_HK417'),
		Weapon('MK11_EOTech', '', { 'EOTech', 'Flashsuppressor', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/MK11/U_MK11'),
		Weapon('MK11_Acog', '', { 'Acog', 'TargetPointer', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/MK11/U_MK11'),
		Weapon('MK11_RifleScope', '', { 'Rifle_Scope', 'Flashsuppressor', 'Weapons/Common/NoPrimaryAccessory' },
			WeaponTypes.Sniper, 'Weapons/MK11/U_MK11'),
		Weapon('SKS_Kobra', '', { 'Kobra', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_2' },
			WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
		Weapon('SKS_PSO-1', '', { 'PSO-1', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_2' },
			WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
		Weapon('SKS_RifleScope', '', { 'Rifle_Scope', 'Heavy_Barrel', 'Weapons/Common/NoPrimaryAccessory', 'CAMO_1' },
			WeaponTypes.Sniper, 'Weapons/SKS/U_SKS'),
		Weapon('SVD_Kobra', '', { 'Kobra', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/SVD/U_SVD'),
		Weapon('SVD_PSO-1', '', { 'PSO-1', 'Target_pointer', 'Weapons/Common/NoPrimaryAccessory' }, WeaponTypes.Sniper,
			'Weapons/SVD/U_SVD'),
...
function WeaponList:_useWeaponType(p_Class, p_Type, p_Name, p_Team)
	...
	if s_WeaponSet == WeaponSets.Custom then
		...
		elseif p_Type == WeaponTypes.Assault or p_Type == WeaponTypes.Carabine or p_Type == WeaponTypes.LMG or
			p_Type == WeaponTypes.Sniper then
