local code = 'fr_FR' -- Add/replace the xx_XX here with your language code (like de_DE, en_EN, or other)!
...
Language:add(code, "Free Gunship Seat", "Libérer une place dans le gunship")
