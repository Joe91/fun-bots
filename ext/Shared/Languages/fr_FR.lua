...
Language:add(code, "Delay for first shot. If too small, there will be great spread in first cycle because it's not compensated yet", "Délai pour le premier coup. S'il est trop petit, il y aura une grande propagation au premier cycle car il n'est pas encore compensé")
...
Language:add(code, "de_DE as sample (default is English, when language file doesn't exist)", "de_DE comme exemple (la valeur par défaut est l'anglais, lorsque le fichier de langue n'existe pas)")
