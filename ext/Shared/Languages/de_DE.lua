...
Language:add(code, "Bots without sniper aim for the head. A more experimental config", "Bots ohne Scharfschützen zielen auf den Kopf. Eher eine experimentelle Konfiguration")
Language:add(code, "Bots with Sniper aim for head", "Bots mit Sniper zielen auf den Kopf")
Language:add(code, "Bots with sniper aim for the head. A more experimental config", "Bots mit Scharfschützen zielen auf den Kopf. Eher eine experimentelle Konfiguration")
Language:add(code, "Bots with Support LMGs aim for head", "Bots mit Unterstützungs-LMGs zielen auf den Kopf")
Language:add(code, "Bots with support LMGs aim for the head. A more experimental config", "Bots mit Unterstützungs-LMGs zielen auf den Kopf. Eher eine experimentelle Konfiguration")
...
Language:add(code, "Beacon", "Leuchtfeuer")
Language:add(code, "Use jets", "Verwenden Sie Düsen")
