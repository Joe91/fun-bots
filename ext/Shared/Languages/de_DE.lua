...
Language:add(code, "Select the weapon the bots use", "Waffe die die Bots verwenden sollen")
Language:add(code, "Bot Kit", "Ausrüstung der Bots")
Language:add(code, "The Kit of the Bots", "die Ausrüstung die die Bots verwenden sollen")
Language:add(code, "Bot Color", "Bot Aussehen")
Language:add(code, "The Color of the Bots", "Wähle das Aussehen der Bots")
Language:add(code, "Zombie Mode", "Zobie-Modus")
Language:add(code, "Zombie Bot Mode", "Alle Bots sind Zombies")

--DIFFICULTY
Language:add(code, "Bot Aim Worsening", "")
Language:add(code, "make aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy).", "")
...
Language:add(code, "Degrees of FOV of Bot in verticle direction", "")
Language:add(code, "Max Raycast Distance", "")
Language:add(code, "meters bots start shooting at player", "")
Language:add(code, "Max Shoot-Distance No Sniper", "")
Language:add(code, "meters a bot (not sniper) start shooting at player", "")
Language:add(code, "Max Shoot-Distance Pistol", "")
Language:add(code, "only in auto-weapon-mode, the distance until a bot switches to pistol if his magazine is empty", "")
...
Language:add(code, "bot takes falldamage or explosion-damage from onw frags", "")
Language:add(code, "Bots teleport them when stuck", "")
Language:add(code, "bot teleport to their target if stuck", "")
...
Language:add(code, "max time bots move straigt, before sidewares-movement (in sec)", "")
...
Language:add(code, "Bots use vehicles", "")
...
Language:add(code, "meters bots in Vehicles start shooting at player", "")
Language:add(code, "Max Shoot-Distance No Anti Air", "")
Language:add(code, "meters a vehicle (no Anti-Air) starts shooting at player", "")
...
Language:add(code, "Draw Spawn Points", "")
Language:add(code, "Range of Spawnpoints", "")
...
Language:add(code, "update intervall of trace", "")
...
Language:add(code, "if that close, the bot can hear you", "")
Language:add(code, "Bot attack Bot distance", "")
Language:add(code, "meters a bot attacks an other bot", "")
...
Language:add(code, "speed facator", "")
Language:add(code, "reduces the movementspeed. 1 = normal, 0 = standing.", "")
Language:add(code, "speed facator attack", "")
...
Language:add(code, "delay for first shot. If too small, there will be great spread in first cycle because its not kompensated jet.", "")
Language:add(code, "Bot min time shoot at player", "")
Language:add(code, "the minimum time a bot shoots at one player - recommended minimum 1.5, below this you will have issues.", "")
...
Language:add(code, "maximun yaw per sec", "")
Language:add(code, "in Degree. Rotaion-Movement per second.", "")
...
Language:add(code, "headshot factor bots", "")
Language:add(code, "factor for damage if headshot (only in Fake-mode)", "")
...
Language:add(code, "spawn-mehtod", "")
...
Language:add(code, "Finish", "Fertig")
Language:add(code, "Connect", "Verbinden")
Language:add(code, "Clear Selection", "Auswahl Zurücksetzen")
Language:add(code, "Select Between", "Alle dazwischen auswählen")
Language:add(code, "Remove", "Entfernen")
Language:add(code, "Unlink", "Verbindung trennen")
Language:add(code, "Select Previous", "Vorherigen auswählen")
Language:add(code, "Add", "Hinzufügen")
Language:add(code, "Link", "Verbinden")
Language:add(code, "Select Next", "Nächsten auswählen")
Language:add(code, "Split", "Aufteilen")

-- Strings of ../ext/Server/BotSpawner.lua
Language:add(code, "CANT_JOIN_BOT_TEAM", "DU_KANNST_DEM_BOT_TEAM_NICHT_BEITRETEN")

-- Strings of ../ext/Server/UIServer.lua
Language:add(code, "Bot respawn activated!", "Bots werden respawnen")
Language:add(code, "Bot respawn deactivated!", "Bots werden nicht respawnen")
Language:add(code, "Bots will attack!", "Bots attackieren")
Language:add(code, "Bots will not attack!", "Bots attackieren nicht")
Language:add(code, "%s is currently not implemented.", "%s ist nicht implementiert")
Language:add(code, "Merge", "Zusammenfügen")
Language:add(code, "Move", "Bewegen")
Language:add(code, "Select", "Auswählen")
Language:add(code, "Set Input", "Eingabe setzen")
Language:add(code, "Settings has been saved temporarily.", "Einstellungen wurden temporär gespeichert")
Language:add(code, "Settings has been saved.", "Einstellungen gespeichert")

-- Strings of ../ext/Shared/NodeCollection.lua
Language:add(code, "Loaded %d paths with %d waypoints for map %s", "%d Pfade mit %d Wegpunkten für Karte %s wurden geladen")
Language:add(code, "Failed to execute query: %s", "Ausführen in Databank fehlgeschlagen: %s")
Language:add(code, "Saved %d paths with %d waypoints for map %s", "%d Pfade mit %d Wegpunkten für Karte %s wurden gespeichert")
...
Language:add(code, "Attack", "Angreifen")
...
Language:add(code, "Enter Vehicle", "in Fahrzeug einsteigen")
Language:add(code, "Drop Ammo", "Munition legen")
Language:add(code, "Drop Medkit", "Medkit legen")
Language:add(code, "Commands", "Befehler")
Language:add(code, "Attack Objective", "Ziel Angreifen")
Language:add(code, "Defend Objective", "Ziel Verteidigen")
Language:add(code, "Repair Vehicle", "Fahrzeug reparieren")
Language:add(code, "Save in progress...", "Speichern in Arbeit")
Language:add(code, "Use air vehicles", "")
Language:add(code, "Bots use air-vehicles", "")
