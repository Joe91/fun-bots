local code = 'de_DE' -- Add/replace the xx_XX here with your language code (like de_DE, en_EN, or other)!
...
Language:add(code, "Free Gunship Seat", "Gunship-Platz freimachen")
