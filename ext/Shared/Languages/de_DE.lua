...
Language:add(code, "Use a random weapon out of the weaponset", "")
...
Language:add(code, "Distance bots attacks other bots", "")
...
Language:add(code, "Delay for first shot. If too small, there will be great spread in first cycle because its not compensated yet.", "")
...
Language:add(code, "In Degrees. Rotaion-Movement per second.", "")
