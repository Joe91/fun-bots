...
Language:add(code, "Save", "Speichern")
Language:add(code, "Merge", "Zusammenfügen")
Language:add(code, "Move", "Bewegen")
Language:add(code, "Delete", "Entfernen")
Language:add(code, "Select", "Auswählen")
Language:add(code, "Split", "Trennen")
Language:add(code, "Set Input", "Eingabe setzen")
Language:add(code, "Create", "Erstelle")
Language:add(code, "Load", "Laden")
