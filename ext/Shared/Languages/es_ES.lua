...
Language:add(code, "Max Distance a sniper soldier shoots back if Hit", "Distancia máxima que un soldado francotirador dispara si es golpeado")
Language:add(code, "Meters until snipers shoot back if hit", "Metros hasta que los francotiradores devuelvan los disparos si son golpeados")
...
Language:add(code, "Degrees of vertical FOV of Non AA - Vehicles", "Grados de FOV vertical de Non AA - Vehículos")
...
Language:add(code, "Max Bots per vehicle", "Max Bots por vehículo")
...
Language:add(code, "Vehicles like tanks do not stop for shooting", "Los vehículos como tanques no se detienen para disparar.")
Language:add(code, "Speed factor vehicle attack", "Ataque de vehículos con factor de velocidad")
...
Language:add(code, "Target distance waypoint air vehicles", "Vehículos aéreos de waypoint de distancia objetivo")
Language:add(code, "The distance the bots have to reach to continue with the next Waypoint on air vehicles", "La distancia que deben recorrer los robots para continuar con el siguiente Waypoint en vehículos aéreos.")
...
Language:add(code, "Sniper-Spot", "Punto de francotirador")
Language:add(code, "POI", "PDI")
