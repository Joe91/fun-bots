...
Language:add(code, "Bot takes falldamage or explosion-damage from own frags", "los Bots tomarán daño de las caídas y/o daño de las explosiones de sus propias granadas")
...
Language:add(code, "Distance the bots have to reach to continue with the next Waypoint", "distancia la cual los bots tiene que alcanzar para continuar con la siguiente ruta")
