...
Language:add(code, "Damage Factor Vehicles", "Damage Factor Vehicles")
Language:add(code, "Original Damage from bots in vehicles gets multiplied by this", "Original Damage from bots in vehicles gets multiplied by this")
Language:add(code, "Vehicle Aim Worsening", "Vehicle Aim Worsening")
Language:add(code, "Make bots in vehicles aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "Make bots in vehicles aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)")
Language:add(code, "Target distance waypoint air vehicles", "Target distance waypoint air vehicles")
Language:add(code, "The distance the bots have to reach to continue with the next Waypoint on air vehicles", "The distance the bots have to reach to continue with the next Waypoint on air vehicles")
...
Language:add(code, "Bots can use jets", "Bots can use jets")
Language:add(code, "Bots Revive Bots", "Bots Revive Bots")
Language:add(code, "Bots revive other Bots", "Bots revive other Bots")
Language:add(code, "Defend objectives", "Defend objectives")
Language:add(code, "Bots will stay on captured objectives and defend them", "Bots will stay on captured objectives and defend them")
Language:add(code, "Enable vehicle paradrop", "Enable vehicle paradrop")
Language:add(code, "Bots can spawn on vehicles inside C-130 gunship", "Bots can spawn on vehicles inside C-130 gunship")
...
Language:add(code, "Draw Parsed Spawns", "Draw Parsed Spawns")
Language:add(code, "Draw the parsed spawn-points with parsed links", "Draw the parsed spawn-points with parsed links")
Language:add(code, "AA Aim Worsening", "AA Aim Worsening")
Language:add(code, "Make bots in AA aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "Make bots in AA aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)")
Language:add(code, "Gunship Aim Worsening", "Gunship Aim Worsening")
Language:add(code, "Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)")
Language:add(code, "Chopper Aim Worsening", "Chopper Aim Worsening")
Language:add(code, "Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)")
Language:add(code, "Vehicle Plane Aim Worsening", "Vehicle Plane Aim Worsening")
Language:add(code, "See VehicleAimWorsening, only for Planes", "See VehicleAimWorsening, only for Planes")
Language:add(code, "Max Shoot Distance Air Missiles", "Max Shoot Distance Air Missiles")
