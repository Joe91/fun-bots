...
Language:add(code, "Bot takes falldamage or explosion-damage from own frags", "Bot takes falldamage or explosion-damage from own frags")
...
Language:add(code, "Use a random weapon out of the weaponset", "Use a random weapon out of the weaponset")
...
Language:add(code, "Delay for first shot. If too small, there will be great spread in first cycle because its not compensated yet.", "Delay for first shot. If too small, there will be great spread in first cycle because its not compensated yet.")
...
Language:add(code, "in Degrees. Rotaion-Movement per second.", "in Degrees. Rotaion-Movement per second.")
Language:add(code, "Target distance waypoint", "Target distance waypoint")
Language:add(code, "Distance the bots have to reach to continue with the next Waypoint", "Distance the bots have to reach to continue with the next Waypoint")
