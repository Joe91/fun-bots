...
Language:add(code, "make aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy).", "make aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy).")
...
Language:add(code, "number to increase Bots, when new players join", "number to increase Bots, when new players join")
...
Language:add(code, "Save", "Save")
Language:add(code, "Merge", "Merge")
Language:add(code, "Move", "Move")
Language:add(code, "Delete", "Delete")
Language:add(code, "Select", "Select")
Language:add(code, "Split", "Split")
Language:add(code, "Set Input", "Set Input")
Language:add(code, "Create", "Create")
Language:add(code, "Load", "Load")
