...
Language:add(code, "Vehicle Air Aim Worsening", "Vehicle Air Aim Worsening")
Language:add(code, "See VehicleAimWorsening, only for Air-Vehicles", "See VehicleAimWorsening, only for Air-Vehicles")
