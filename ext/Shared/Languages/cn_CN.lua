...
Language:add(code, "Bots can use jets", "机器人可以使用喷气机")
Language:add(code, "Bots Revive Bots", "机器人复活机器人")
Language:add(code, "Bots revive other Bots", "机器人复活其他机器人")
Language:add(code, "Defend objectives", "保卫目标")
Language:add(code, "Bots will stay on captured objectives and defend them", "机器人将留在占领的目标上并保卫它们")
Language:add(code, "Enable vehicle paradrop", "启用车辆空投")
Language:add(code, "Bots can spawn on vehicles inside C-130 gunship", "机器人可以在 C-130 武装直升机内的车辆上生成")
