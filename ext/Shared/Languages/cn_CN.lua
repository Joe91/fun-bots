...
Language:add(code, "Bots use vehicles", "BOT驾驶载具")
...
Language:add(code, "meters bots in Vehicles start shooting at player", "载具的最大辐射距离")
Language:add(code, "Max Shoot-Distance No Anti Air", "最远射程不包括防空车")
Language:add(code, "meters a vehicle (no Anti-Air) starts shooting at player", "距离多少米的载具（不包括防空车）开始向玩家射击")
...
Language:add(code, "Bots use air-vehicles", "BOT驾驶空中载具")
