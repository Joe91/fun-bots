...
Language:add(code, "Exit Vehicle Passengers", "出口车辆乘客")
Language:add(code, "Exit Vehicle All", "退出车辆全部")
Language:add(code, "Remove Vehicle Data", "删除车辆数据")
Language:add(code, "Vehicle", "车辆")
Language:add(code, "Add Vehicle", "添加车辆")
Language:add(code, "Set Vehicle Path-Type", "设置车辆路径类型")
Language:add(code, "Remove Vehicle", "移除车辆")
Language:add(code, "Add Tank", "添加坦克")
Language:add(code, "Add Chopper", "添加斩波器")
Language:add(code, "Add Plane", "添加平面")
Language:add(code, "Add Other Vehicle", "添加其他车辆")
Language:add(code, "Set Vehicle Spawn-Path", "设置载具生成路径")
Language:add(code, "US", "我们")
Language:add(code, "Team", "团队")
Language:add(code, "RU", "俄罗斯")
Language:add(code, "Vehicle 1", "车辆 1")
Language:add(code, "Vehicle 2", "车辆 2")
Language:add(code, "Vehicle 3", "车辆 3")
Language:add(code, "Vehicle 4", "车辆 4")
Language:add(code, "Vehicle 5", "车辆 5")
Language:add(code, "Index", "指数")
Language:add(code, "Vehicle 6", "车辆 6")
Language:add(code, "Vehicle 7", "车辆 7")
Language:add(code, "Vehicle 8", "车辆 8")
Language:add(code, "Vehicle 9", "车辆 9")
Language:add(code, "Vehicle 10", "车辆 10")
...
Language:add(code, "Base US", "美国基地")
...
Language:add(code, "base ru stage 1", "基础 ru 阶段 1")
Language:add(code, "base ru stage 2", "基础 ru 阶段 2")
Language:add(code, "base ru stage 3", "基础 ru 阶段 3")
Language:add(code, "base ru stage 4", "基础 ru 阶段 4")
Language:add(code, "base ru stage 5", "基础 ru 阶段 5")
Language:add(code, "base us stage 1", "基地美国第一阶段")
Language:add(code, "base us stage 2", "基地美国第 2 阶段")
Language:add(code, "base us stage 3", "基地美国第 3 阶段")
Language:add(code, "base us stage 4", "基地美国第 4 阶段")
Language:add(code, "base us stage 5", "基地美国第 5 阶段")
Language:add(code, "Objective", "客观的")
