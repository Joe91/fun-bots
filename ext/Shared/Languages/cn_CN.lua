...
Language:add(code, "Damage Bot Bullet", "BOT普通子弹伤害");
Language:add(code, "The damage a normal Bullet does", "BOT普通子弹给玩家造成的伤害");
Language:add(code, "Damage Bot Sniper", "BOT狙击枪伤害");
Language:add(code, "The damage a Sniper-Bullet does", "BOT狙击枪子弹给玩家造成的伤害");
Language:add(code, "Damage Bot Shotgun", "BOT霰弹枪伤害");
Language:add(code, "The damage a Shotgun-Bullet does", "BOT霰弹枪子弹给玩家造成的伤害");
Language:add(code, "Damage Bot Melee", "BOT近战伤害");
Language:add(code, "The Damage a melee-attack does", "BOT近战给玩家造成的伤害");
