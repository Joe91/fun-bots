...
Language:add(code, "Keep a Vehicle Seat For Player", "为玩家保留载具空位")
Language:add(code, "To keep a vehicle seat for the player always or not (default true)", "始终为玩家保留载具空位（默认为true）")
