...
Language:add(code, "Max Distance a normal soldier shoots back if Hit", "普通士兵击中目标后回击的最大距离")
...
Language:add(code, "Meters until snipers shoot back if hit", "狙击手会开枪还击以的米数距离")
...
Language:add(code, "Bot min time shoot at player in vehicle", "机器人射击载具中玩家的最短距离")
