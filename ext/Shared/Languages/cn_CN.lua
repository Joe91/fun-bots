...
Language:add(code, "Reduces the movementspeed while attacking. 1 = normal, 0 = standing.", "攻击时降低移动速度. 1 = 正常,0 = 不动")
...
Language:add(code, "Min time bots move sidewards or staight before switching (in sec)", "BOT切换前横向或直线移动的最短时间(秒为单位)")

-- EXPERT 
Language:add(code, "Bot first shot delay", "BOT第一枪延迟")
Language:add(code, "Delay for first shot. If too small, there will be great spread in first cycle because its not compensated yet.", "第一枪延迟.如果太小,第一个回合会有很大的扩散,因为它还没有得到补偿")
