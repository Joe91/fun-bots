...
Language:add(code, "Vehicle Air Aim Worsening", "Piora da mira aérea do veículo")
Language:add(code, "See VehicleAimWorsening, only for Air-Vehicles", "Ver VehicleAimWorsening, apenas para Veículos Aéreos")
