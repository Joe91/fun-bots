...
Language:add(code, "Add Mcom-Action", "Adicionar Mcom-Action")
Language:add(code, "Overwrite: Loop-Path", "Sobrescrever: Loop-Path")
...
Language:add(code, "Exit Vehicle Passengers", "Saída de passageiros do veículo")
Language:add(code, "Exit Vehicle All", "Sair de todos os veículos")
...
Language:add(code, "Base US", "Base nos EUA")
