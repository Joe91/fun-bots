...
Language:add(code, "AA Aim Worsening", "")
Language:add(code, "Make bots in AA aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "")
Language:add(code, "Gunship Aim Worsening", "")
Language:add(code, "Make bots in Gunships aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "")
Language:add(code, "Chopper Aim Worsening", "")
Language:add(code, "Make bots in Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "")
Language:add(code, "Transport Chopper Aim Worsening", "")
Language:add(code, "Make bots in Transport Choppers aim worse: for difficulty: 0 = no offset (hard), 1 or even greater = more sway (easy)", "")
Language:add(code, "Vehicle Plane Aim Worsening", "")
Language:add(code, "See VehicleAimWorsening, only for Planes", "")
...
Language:add(code, "Max Shoot Distance Air Missiles", "")
Language:add(code, "Meters before bots will start shooting with stingers", "")
...
Language:add(code, "Degrees of FOV of AA - Vehicles", "")
Language:add(code, "Max Raycast Distance for Gunships", "")
Language:add(code, "Meters bots in the Gunship start shooting at players", "")
...
Language:add(code, "Draw Parsed Spawns", "")
Language:add(code, "Draw the parsed spawn-points with parsed links", "")
