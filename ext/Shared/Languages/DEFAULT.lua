...
Language:add(code, "Path already has objective: ", "");
Language:add(code, "Must select at least one node", "");
...
Language:add(code, "default bot team. 0 = auto, 1 = US (forced), 2 = RU (forced)", "");
...
Language:add(code, "Trace Delta time", "");
...
Language:add(code, "Trace %d done with %d Waypoints.", "");
