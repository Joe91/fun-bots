...
Config = {
	...
	BotColor = BotColors.RANDOM_COLOR,	-- The Colour of the Bots. 
	...
	BotSniperWorseningSkill = 0.50,		-- See BotWorseningSkill - only for BOT's using sniper bolt-action rifles. 
	...
	InitNumberOfBots = 10,				-- Bots for spawn mode. 
	...
	BotNewLoadoutOnSpawn = true,		-- Bots get a new kit and colour, if they respawn. 
	...
	AssaultWeaponSet = WeaponSets.Custom,	-- Weapon set of Assault class. Custom uses the Shared/WeaponLists 
	EngineerWeaponSet = WeaponSets.Custom,	-- Weapon set of Engineer class. Custom uses the Shared/WeaponLists 
	SupportWeaponSet = WeaponSets.Custom,	-- Weapon set of Support class. Custom uses the Shared/WeaponLists 
	ReconWeaponSet = WeaponSets.Custom,	-- Weapon set of Recon class. Custom uses the Shared/WeaponLists 
	...
	-- EXPERT 
	BotFirstShotDelay = 0.25,			-- Delay for first shot. If too small, there will be great spread in first cycle because it's not compensated yet. 
	...
	Language = nil,						-- de_DE as sample (default is English, when language file doesn't exists). 
}
