...
Config = {
	...
	MeleeAttackCoolDown = 2.5, -- The time a bot waits before attacking with melee again
	...
	BotMinTimeAttackOnePlayer = 2.5, -- The minimum time a bot shoots at one player for - recommended minimum 1.5, below this you will have issues
	...
	BotAttackDuration = 20, -- The minimum time a bot tries to shoot a player - recommended minimum 3.0, below this you will have issues
