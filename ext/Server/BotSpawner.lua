...
function BotSpawner:_SpawnSingleWayBot(p_Player, p_UseRandomWay, p_ActiveWayIndex, p_IndexOnPath, p_ExistingBot,
                                       p_ForcedTeam)
...
function BotSpawner:_GetKitAppearanceCustomization(p_Bot, p_Kit, p_Color)
	-- Create the loadouts
