...
function BotWeaponHandling:UpdateDeployAndReload(p_Bot, p_Deploy)
	...
	if p_Bot.m_ActiveWeapon ~= nil and p_Bot._ReloadTimer > 1.5 and p_Bot._ReloadTimer < 2.5 and p_Bot.m_Player.soldier.weaponsComponent.currentWeapon.primaryAmmo <= p_Bot.m_ActiveWeapon.reload then
...
function BotWeaponHandling:UpdateWeaponSelection(p_Bot)
	...
	if p_Bot._ActiveAction ~= BotActionFlags.MeleeActive then
		if p_Bot.m_Player.soldier.weaponsComponent ~= nil then
			...
			elseif p_Bot._ActiveAction == BotActionFlags.ReviveActive or (p_Bot._WeaponToUse == BotWeapons.Gadget2 and Config.BotWeapon == BotWeapons.Auto) or Config.BotWeapon == BotWeapons.Gadget2 then
			...
			elseif p_Bot._ActiveAction == BotActionFlags.RepairActive or (p_Bot._WeaponToUse == BotWeapons.Gadget1 and Config.BotWeapon == BotWeapons.Auto) or Config.BotWeapon == BotWeapons.Gadget1 then
				if p_Bot.m_Player.soldier.weaponsComponent.currentWeaponSlot ~= WeaponSlot.WeaponSlot_2 and p_Bot.m_Player.soldier.weaponsComponent.currentWeaponSlot ~= WeaponSlot.WeaponSlot_4 then
			...
			elseif p_Bot._ActiveAction == BotActionFlags.GrenadeActive or (p_Bot._WeaponToUse == BotWeapons.Grenade and Config.BotWeapon == BotWeapons.Auto) or Config.BotWeapon == BotWeapons.Grenade then
			...
			elseif (p_Bot._WeaponToUse == BotWeapons.Pistol and Config.BotWeapon == BotWeapons.Auto) or Config.BotWeapon == BotWeapons.Pistol then
				...
				if p_Bot.m_Player.soldier.weaponsComponent.weapons[2] ~= nil and p_Bot.m_Player.soldier.weaponsComponent.weapons[2].secondaryAmmo < p_Bot.m_Player.soldier.weaponsComponent.weapons[2].primaryAmmo + 1 then
					p_Bot.m_Player.soldier.weaponsComponent.weapons[2].secondaryAmmo = p_Bot.m_Player.soldier.weaponsComponent.weapons[2].primaryAmmo + 3
				end
			elseif (p_Bot._WeaponToUse == BotWeapons.Primary and Config.BotWeapon == BotWeapons.Auto) or Config.BotWeapon == BotWeapons.Primary then
				...
				if p_Bot.m_Player.soldier.weaponsComponent.weapons[1] ~= nil and p_Bot.m_Player.soldier.weaponsComponent.weapons[1].secondaryAmmo < p_Bot.m_Player.soldier.weaponsComponent.weapons[1].primaryAmmo + 1 then
					p_Bot.m_Player.soldier.weaponsComponent.weapons[1].secondaryAmmo = p_Bot.m_Player.soldier.weaponsComponent.weapons[1].primaryAmmo + 3
				end
			end
		end
	end
