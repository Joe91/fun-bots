...
function FunBotClient:CheckForBotBotAttack(p_BotName1, p_BotName2, p_InVehicle1, p_InVehicle2)
	m_ClientBotManager:CheckForBotBotAttack(p_BotName1, p_BotName2, p_InVehicle1, p_InVehicle2)
end
