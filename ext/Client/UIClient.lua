...
function FunBotUIClient:_onUISettings(data)
	...
	settings:add("GLOBAL", "Number", "botAimWorsening", "Aim Worsening", tostring(data.botAimWorsening * 100),"0", "0 = hard, 100 (or higher) = easy. Only takes effect on level Start");
	settings:addList("GLOBAL", "botKit", "Bot Kit", Kits, tostring(data.botKit), "RANDOM_KIT", "The Kit a bots spawns with.");
	settings:addList("GLOBAL", "botColor", "Bot Color", Colors, tostring(data.botColor), "RANDOM_COLOR", "The Kit-Color a bots spawns with.");
