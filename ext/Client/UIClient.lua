...
function FunBotUIClient:_onUISettings(data)
	...
	settings:add("DIFFICULTY", "Float", "botAimWorsening", Language:I18N("Aim Worsening"), data.botAimWorsening, 0.2, Language:I18N("0 = hard, 1 (or higher) = easy. Only takes effect on level Start"));
	...
	settings:add("DIFFICULTY", "Float", "damageFactorAssault", Language:I18N("Factor for Assault-Weapon-Damage"), data.damageFactorAssault, 0.8, Language:I18N("Origninal Damage from bots gets multiplied by this"));
	settings:add("DIFFICULTY", "Float", "damageFactorCarabine", Language:I18N("Factor for Carabine-Weapon-Damage"), data.damageFactorCarabine, 0.8, Language:I18N("Origninal Damage from bots gets multiplied by this"));
	settings:add("DIFFICULTY", "Float", "damageFactorLMG", Language:I18N("Factor for LMG-Weapon-Damage"), data.damageFactorLMG, 0.8, Language:I18N("Origninal Damage from bots gets multiplied by this"));
	...
	settings:add("DIFFICULTY", "Float", "damageFactorShotgun", Language:I18N("Factor for Shotgun-Weapon-Damage"), data.damageFactorShotgun, 0.8, Language:I18N("Origninal Damage from bots gets multiplied by this"));
	...
	settings:add("DIFFICULTY", "Float", "damageFactorKnife", Language:I18N("Factor for Knife-Weapon-Damage"), data.damageFactorKnife, 0.8, Language:I18N("Origninal Damage from bots gets multiplied by this"));
