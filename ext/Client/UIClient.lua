...
function FunBotUIClient:_onUISettings(data)
	...
	settings:add("ADVANCED", "Integer", "overWriteBotAttackMode", Language:I18N("Overwrite Speed-Mode"), data.overWriteBotAttackMode, 0, Language:I18N("!!Affects Aiming!!! 0 = no overwrite. 1 = prone, 2 = crouch, 3 = walk, 4 = run"));
